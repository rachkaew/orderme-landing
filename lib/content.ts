...
export const defaultContent: SiteContent = {
  hero: {
    ...
    primaryCta: "สมัครเปิดร้านฟรี",
    secondaryCta: "ดูวิธีการใช้งาน",
    trustLine: "ยืนยันอีเมล · รอตรวจไม่เกิน 24 ชม. · ได้ username + คู่มือทางอีเมล",
  },
  stats: [
  ...
  cta: {
    ...
    subtitle:
      "เริ่มต้นได้วันนี้ ไม่ต้องมีทีม IT สมัครเปิดร้านเอง ยืนยันอีเมล แล้วรอตรวจไม่เกิน 24 ชม.",
    primaryCta: "สมัครเปิดร้าน",
